		...
		<div>
			...
			<div>
				{bookings?.length > 0 && bookings.map(booking => (
					<Link to={"/account/bookings/" + booking._id} className="flex gap-4 bg-gray-200 rounded-2xl overflow-hidden mb-4" key={booking._id}>
						<div className="flex h-40 w-40">
							<PlaceImg place={booking.place} />
						</div>
						<div className="py-3 pr-6 grow">
							<h2 className="text-xl font-bold">{booking.place.title}</h2>
							<div className="flex border-t border-gray-500 mt-2 " >
